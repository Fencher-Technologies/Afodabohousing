  ...
  sections: [
    {
      ...
      content:
        "Afodabo is a property and tenancy management platform that provides technology tools for property managers, landlords, and tenants. This Privacy Policy explains how we collect, use, protect, and share your personal information when you use our platform.",
    },
    {
  ...
  sections: [
    {
      title: "1. Introduction",
      content:
        "These Terms of Service constitute a legal agreement between you and Afodabo governing your use of the Afodabo platform. By creating an account or using our services, you agree to be bound by these terms. If you do not agree, you may not use the platform.",
    },
    {
    ...
    },
    {
      title: "7. Payments",
      content:
        "Afodabo helps manage payment information and records. Actual payment obligations and financial agreements remain between the involved parties. Third-party payment providers may process transactions, and their terms and conditions also apply. Afodabo is not a financial institution and does not hold funds on behalf of users.",
    },
    {
    ...
    },
    {
      ...
      content:
        "The Afodabo platform, including its software, design, branding, and content, is owned by Afodabo and protected by intellectual property laws. You may not copy, modify, distribute, or create derivative works without our express permission.",
    },
    {
