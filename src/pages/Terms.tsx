...
Axis reserves the right to remove any listing that violates these terms, contains misleading information, or is reported as fraudulent by multiple users, without prior notice or refund.`,
  ...
  {
    title: '5. Payments',
    content: `Online rent payments are processed via PesaPal and are subject to PesaPal's terms of service. Payment proof uploads are reviewed by the house manager, not Axis. We do not guarantee the receipt of funds or the accuracy of payment confirmations provided by house managers.

Axis is not liable for payment disputes between tenants and house managers. All rent amounts are in Ugandan Shillings (UGX) unless otherwise stated.`,
  },
  {
...
To the maximum extent permitted by Ugandan law, Axis shall not be liable for any indirect, incidental or consequential damages arising from your use of the platform, including property damage, personal injury, financial loss resulting from rental fraud, or disputes between tenants and house managers.`,
  },
  {
  ...
  {
    title: '11. Contact',
    content: `For questions about these Terms of Service, contact us at info@axishousing.com or write to Axis Ltd, Kampala, Uganda.`,
  },
];
      ...
      <div className="container py-14 max-w-4xl">
        <div className="bg-card border border-border rounded-2xl p-8 shadow-card mb-8">
          <p className="text-muted-foreground leading-relaxed text-base">
            These Terms of Service govern your access to and use of the Axis platform, operated by Axis Ltd, a company registered in Uganda. Please read these terms carefully before using our services.
          </p>
        </div>
