...
const SECTIONS = [
  {
    ...
    content: `By accessing or using the Afodabo Housing platform, you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, you may not use our services. These terms apply to all users, including tenants, house managers and administrators.`,
  },
  {
...
Afodabo Housing reserves the right to remove any listing that violates these terms, contains misleading information, or is reported as fraudulent by multiple users, without prior notice or refund.`,
  },
  {
    title: '4. Tenancy Agreements',
    content: `Digital tenancy agreements created on Afodabo Housing are binding between the tenant and house manager. Afodabo Housing acts as a facilitating platform only and is not a party to any tenancy agreement. Disputes between tenants and house managers are to be resolved directly or through the appropriate Ugandan courts.`,
  },
  {
    title: '5. Payments',
    content: `Online rent payments are processed via PesaPal and are subject to PesaPal's terms of service. Payment proof uploads are reviewed by the house manager, not Afodabo Housing. We do not guarantee the receipt of funds or the accuracy of payment confirmations provided by house managers.

Afodabo Housing is not liable for payment disputes between tenants and house managers. All rent amounts are in Ugandan Shillings (UGX) unless otherwise stated.`,
  },
  {
    title: '6. SMS Notifications',
    content: `By providing a phone number, you consent to receive SMS messages from Afodabo Housing via EgoSMS. Standard mobile carrier rates may apply. We send operational SMS messages only, including rent reminders, payment confirmations and account notices. We do not send promotional SMS without your explicit consent.`,
  },
  {
...
Violation of these rules will result in immediate account suspension and, where applicable, reporting to relevant Ugandan authorities.`,
  },
  {
    ...
    content: `Afodabo Housing provides the platform on an "as is" basis. We make no warranties, express or implied, regarding the accuracy of listings, the conduct of house managers or tenants, or the security of any specific property.

To the maximum extent permitted by Ugandan law, Afodabo Housing shall not be liable for any indirect, incidental or consequential damages arising from your use of the platform, including property damage, personal injury, financial loss resulting from rental fraud, or disputes between tenants and house managers.`,
  },
  {
  ...
  {
    title: '11. Contact',
    content: `For questions about these Terms of Service, contact us at info@afodabohousing.com or write to Afodabo Housing Ltd, Kampala, Uganda.`,
  },
];
      ...
      <div className="container py-14 max-w-4xl">
        <div className="bg-card border border-border rounded-2xl p-8 shadow-card mb-8">
          <p className="text-muted-foreground leading-relaxed text-base">
            These Terms of Service govern your access to and use of the Afodabo Housing platform, operated by Afodabo Housing Ltd, a company registered in Uganda. Please read these terms carefully before using our services.
          </p>
        </div>
